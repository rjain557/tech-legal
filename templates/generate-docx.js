    ...
    sections: [
      ...
      },
      {
        ...
        children: [
          ...
          spacer(),
          multiRun([{ text: "3.05. Disputed Invoices. ", bold: true, color: CHARCOAL }, { text: "If Client disputes any portion of an invoice, Client shall notify Technijian in writing within fifteen (15) days of the invoice date, specifying the nature of the dispute. Client shall pay all undisputed amounts by the due date. The Parties shall work in good faith to resolve any disputes." }]),
          spacer(),
          ...
          spacer(),
          multiRun([{ text: "5.03. Data Liability. ", bold: true, color: CHARCOAL }, { text: "While Technijian shall use commercially reasonable efforts to protect Client Data in its possession, Client acknowledges that:" }]),
